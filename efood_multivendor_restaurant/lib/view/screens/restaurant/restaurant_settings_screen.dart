        ...
        return Column(children: [
          ...
          !restController.isLoading ? CustomButton(
            ...
            onPressed: () {
              ...
              }else if(_restaurant.selfDeliverySystem == 1 && _perKmFee.isNotEmpty && _minimumFee.isEmpty) {
                showCustomSnackBar('enter_minimum_delivery_fee'.tr);
              }else if(_restaurant.selfDeliverySystem == 1 && _minimumFee.isNotEmpty && _perKmFee.isEmpty) {
